...
public class StatsCommand extends Command implements IMaintenanceCommand {
    ...
    public void onInvoke(Guild guild, TextChannel channel, Member invoker, Message message, String[] args) {
        ...
        eb.addField("Memory Stats", "Reserved memory: " + Runtime.getRuntime().totalMemory() / (1024.0 * 1024.0 * 1024.0) + "MB\n" + "-> Of which is used: " + (Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory()) / (1024.0 * 1024.0 * 1024.0) + "MB\n" + "-> Of which is free: " + Runtime.getRuntime().freeMemory() / (1024.0 * 1024.0 * 1024.0) + "MB\n" + "Max reservable: " + Runtime.getRuntime().maxMemory() / (1024.0 * 1024.0 * 1024.0) + "MB\n", true);
